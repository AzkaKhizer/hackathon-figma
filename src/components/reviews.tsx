...
export default function CustomerTestimonials() {
  return (
    <main className="md:mt-14 max-w-screen-2xl  mx-auto">
        ...
        <div className="w-[95%]  p-3 md:p-0">
          ...
          <div className="flex justify-between items-center">
           ...
           <div className="flex items-center space-x-2 mt-4 md:mr-4">
              ...
              <Button variant={"outline"} className="rounded-[62px] bg-gray-200">Latest <RiArrowDropDownLine className="ml-2 text-xl"/></Button>
              </div>
              <Button className="rounded-[62px] bg-black text-gray-300 w-[166px]">Write a Review</Button>
      ...
      <Button variant={"outline"} className="mb-8 rounded-[62px]">Load More Reviews</Button>
      </div>
    </main>
  );
}